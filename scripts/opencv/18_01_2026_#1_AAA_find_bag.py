...
paths_value = {
    ...
    "../../data/processed/character_п_1.png": ("п", 2),
    "../../data/processed/character_т_1.png": ("т", 1),
...
ppn = SGDClassifier(loss="perceptron", warm_start=True)
...
for i in range(200, 20, -10):
    ...
    for value in values_pnn:
        new_name = value  + str(size)
        print(new_name)
        values_rename.append( new_name )
    ppn.fit(images_resize, values_rename)

paths_value_for_score = (
    "../../data/processed/character_в_1.png",
    "../../data/processed/character_п_2.png",
    "../../data/processed/character_т_2.png"
)
answers = ("в" , "п", "т")
images_for_score = list()
for path in paths_value_for_score:
    im = cv2.imread(path)
    im = processed_image_for_pnn(processed_image(im))
    images_for_score.append(im)
score = ppn.score(images_for_score, answers)
